			...
			<div class="table-responsive">
				<table class="table table-striped table-hover">
					...
					<tr>
						...
						<td><a class="btn btn-default" href="<?php echo site_url('user/user_update/'.$user["iduser"]); ?>" role="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
						<td><a class="btn btn-default" href="<?php echo site_url('user/user_delete/'.$user["iduser"]); ?>" role="button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
					</tr>
					<?php } ?>
				</table>
			</div>	
